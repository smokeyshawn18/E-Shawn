...
import { Mail, Lock, ArrowRight, SquarePen, SpellCheck } from "lucide-react";
...
const ForgotPassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
          ...
          const res = await axios.post(`${API}/api/v1/auth/forgot-password`, payload);
    ...
    style={{
        background: "linear-gradient(135deg,rgb(14, 87, 113) 0%,rgb(22, 127, 122) 100%)", // New gradient background
                ...
                <div className="card border-0"
                    ...
                    <div className="card-body p-4 p-md-5">
                        <form onSubmit={handleSubmit} className="needs-validation">
                            <div className="mb-4">
                                ...
                                <div className="input-group input-group-lg">
                                    <span className="input-group-text bg-white border-end-0">
                                        <Mail className="text-dark" size={20} /> {/* Changed icon color */}
                                    </span>
                                    <input
                                        type="email"
                            ...
                            <div className="mb-4">
                                <label htmlFor="answer" className="form-label fw-semibold">Answer to Security Question</label>
                                <div className="input-group input-group-lg">
                                    <span className="input-group-text bg-white border-end-0">
                            ...
                            <div className="mb-4">
                                <div className="input-group input-group-lg">
                                    <span className="input-group-text bg-white border-end-0">
                                        <Lock className="text-dark" size={20} /> {/* Changed icon color */}
                                    </span>
                                    <input
                                        type="password"
                                        className="form-control border-start-0 ps-0 shadow-none"
                            ...
                            <button
                                ...
                                style={{
                                    background: "linear-gradient(to right,rgb(23, 106, 179),rgb(19, 101, 195))", // Gradient button color
                                    border: "none",
                                    height: "54px"
                                }}
                            >
